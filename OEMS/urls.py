...
urlpatterns = patterns(
    ...
    url(r'^student/lesson_pick/$', 'student.views.pick',
        name='student_pick'),
    url(r'^student/lesson_drop/$', 'student.views.drop',
        name='student_drop'),
    ...
    url(r'^student/search_experiment/$', 'student.views.search_experiment',
        name='search_experiment'),
    url(r'^student/search_experiment/result/$',
        'student.views.search_experiment_result',
        name='search_experiment_result'),
)
