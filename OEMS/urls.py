...
urlpatterns = patterns(
    ...
    url(r'^teacher/profile/$', 'teacher.views.teacher_profile', name='teacher_profile'),
    url(r'^teacher/edit_success/$', 'teacher.views.edit_success', name='edit_success'),
    ...
    url(r'^teacher/create_lesson/$', 'experiment.views.create_lesson',
        name='create_lesson'),
    url(r'^teacher/lesson_list/$',
        'experiment.views.lesson_list',
