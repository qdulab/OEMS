...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'teacher_teacherprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('teacher', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teacher.Teacher'], unique=True)),
        ...
        db.send_create_signal(u'teacher', ['TeacherProfile'])


    def backwards(self, orm):
        # Deleting model 'TeacherProfile'
        db.delete_table(u'teacher_teacherprofile')
    ...
    models = {
        ...
        u'teacher.teacherprofile': {
            ...
            'teacher': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['teacher.Teacher']", 'unique': 'True'})
        }
    }
