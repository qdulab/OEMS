...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.weight'
        db.add_column(u'experiment_experiment', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.weight'
        db.delete_column(u'experiment_experiment', 'weight')
