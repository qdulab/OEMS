...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'experiments_lessoncategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'experiments', ['LessonCategory'])

        # Adding model 'Lesson'
        db.create_table(u'experiments_lesson', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiments.LessonCategory'])),
        ...
        db.send_create_signal(u'experiments', ['Lesson'])

        # Adding M2M table for field students on 'Lesson'
        m2m_table_name = db.shorten_name(u'experiments_lesson_students')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm[u'experiments.lesson'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'experiments_lessoncategory')

        # Deleting model 'Lesson'
        db.delete_table(u'experiments_lesson')

        # Removing M2M table for field students on 'Lesson'
        db.delete_table(db.shorten_name(u'experiments_lesson_students'))
    ...
    models = {
        ...
        u'experiments.lesson': {
            'Meta': {'object_name': 'Lesson'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['experiments.LessonCategory']"}),
